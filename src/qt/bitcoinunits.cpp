...
{
    switch (unit) {
    case Unit::BTC: return QString("MTBC");
    case Unit::mBTC: return QString("mMTBC");
    case Unit::uBTC: return QString::fromUtf8("µMTBC (mbits)");
...
{
    switch (unit) {
    case Unit::BTC: return QString("Mateablecoins");
    case Unit::mBTC: return QString("Milli-Mateablecoins (1 / 1" THIN_SP_UTF8 "000)");
    case Unit::uBTC: return QString("Micro-Mateablecoins (mbits) (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
