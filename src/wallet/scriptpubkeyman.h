...
public:
    ...
    virtual std::unique_ptr<SigningProvider> GetSolvingProvider(const CScript& script, bool include_private) const { return GetSolvingProvider(script); }
    ...
    virtual SigningResult SignBlockHash(const uint256 &hash, const WitnessV0KeyHash& pkhash, std::vector<unsigned char>& vchSig) const { return SigningResult::SIGNING_FAILED; };
    virtual SigningResult SignBlockHash(const uint256 &hash, const ScriptHash& pkhash, std::vector<unsigned char>& vchSig) const { return SigningResult::SIGNING_FAILED; };
...
public:
    ...
    SigningResult SignBlockHash(const uint256& hash, const WitnessV0KeyHash& pkhash, std::vector<unsigned char>& vchSig) const override;
    SigningResult SignBlockHash(const uint256& hash, const ScriptHash& pkhash, std::vector<unsigned char>& vchSig) const override;
...
public:
    ...
    */
    ...
    std::unique_ptr<SigningProvider> GetSolvingProvider(const CScript& script) const override;
    std::unique_ptr<SigningProvider> GetSolvingProvider(const CScript& script, bool include_private) const override;
